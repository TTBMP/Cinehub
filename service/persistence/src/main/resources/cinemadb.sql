...
BEGIN
	...
	SET counter = 0;
	WHILE counter < nsala * 7 DO
		INSERT INTO `cinemadb`.`posto` (`id_sala`, `posizione`) VALUES ((counter % nsala) + 1, concat('A', counter % 7));
		INSERT INTO `cinemadb`.`posto` (`id_sala`, `posizione`) VALUES ((counter % nsala) + 1, concat('B', counter % 7));
		INSERT INTO `cinemadb`.`posto` (`id_sala`, `posizione`) VALUES ((counter % nsala) + 1, concat('C', counter % 7));
		INSERT INTO `cinemadb`.`posto` (`id_sala`, `posizione`) VALUES ((counter % nsala) + 1, concat('D', counter % 7));
		INSERT INTO `cinemadb`.`posto` (`id_sala`, `posizione`) VALUES ((counter % nsala) + 1, concat('E', counter % 7));
		INSERT INTO `cinemadb`.`posto` (`id_sala`, `posizione`) VALUES ((counter % nsala) + 1, concat('F', counter % 7));
...
BEGIN
	...
	WHILE giorno < 28 DO
		...
		SET dipendente = 1;
		WHILE dipendente <  2 * nproiezionisti DO
			INSERT INTO `cinemadb`.`turno` (`inizio`, `fine`, `id_dipendente`, `data`)
