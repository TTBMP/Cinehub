...
(
    ...
    INDEX `fk_Dipendente_Utente1_idx`
(
    `id_utente` ASC
) VISIBLE,
    INDEX `fk_Dipendente_Cinema1_idx`
(
    `id_cinema` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_Turno_Dipendente1_idx`
(
    `id_dipendente` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `cinemadb`.`dipendente`
(
    `id_utente`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_RichiestaCambio_Turno_idx`
(
    `id_turno_attuale` ASC
) VISIBLE,
    INDEX `fk_RichiestaCambio_Turno1_idx`
(
    `id_turno_richiesto` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_RichiestaFerie_Dipendente1_idx`
(
    `id_richiedente` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_Proiezionista_Dipendente1_idx`
(
    `id_dipendente` ASC
) VISIBLE,
    UNIQUE INDEX `idDIpendente_UNIQUE`
(
    `id_dipendente` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_CartaDiCredito_Utente1_idx`
(
    `id_utente` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_Proiezione_Film1_idx`
(
    `id_film` ASC
) VISIBLE,
    INDEX `fk_Proiezione_Sala1_idx`
(
    `id_sala` ASC
) VISIBLE,
    INDEX `fk_Proiezione_Proiezionista1_idx`
(
    `id_proiezionista` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `cinemadb`.`proiezionista`
(
    `id_dipendente`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_Biglietto_Utente1_idx`
(
    `id_utente` ASC
) VISIBLE,
    INDEX `fk_Biglietto_Posto1_idx`
(
    `id_posto` ASC
) VISIBLE,
    INDEX `fk_Biglietto_Proiezione1_idx`
(
    `id_proiezione` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `cinemadb`.`proiezione`
(
    `id`
)
    ON DELETE NO ACTION
...
/* Sala */
INSERT INTO `cinemadb`.`sala` (`id_cinema`)
VALUES ('1');
INSERT INTO `cinemadb`.`sala` (`id_cinema`)
VALUES ('1');
INSERT INTO `cinemadb`.`sala` (`id_cinema`)
...
VALUES ('2');
/* Dipendente */
INSERT INTO `cinemadb`.`dipendente` (`id_utente`, `id_cinema`, `ore_settimanali`)
VALUES ('1', '2', '36');
INSERT INTO `cinemadb`.`dipendente` (`id_utente`, `id_cinema`, `ore_settimanali`)
VALUES ('2', '1', '30');
/* Posto */
INSERT INTO `cinemadb`.`posto` (`numero`, `fila`, `id_sala`)
VALUES ('1', 'A', '1');
INSERT INTO `cinemadb`.`posto` (`numero`, `fila`, `id_sala`)
VALUES ('2', 'A', '1');
INSERT INTO `cinemadb`.`posto` (`numero`, `fila`, `id_sala`)
...
/* Proiezionista */
INSERT INTO `cinemadb`.`proiezionista` (`id_dipendente`)
VALUES ('2');
/* Film */
