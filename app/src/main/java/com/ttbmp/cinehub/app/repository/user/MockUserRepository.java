...
public class MockUserRepository extends MockRepository implements UserRepository {
    ...
    static {
        mockDataList.addAll(List.of(
                Map.of(ID, "T8SP2uHYdHZfBk6uh3fJ356Sji52", NAME, "Fabio", SURNAME, "Buracchi", EMAIL, "fb@cinehub.com"),
                Map.of(ID, "gVUYDMojhmeFkErlbF0WWLQWMPn1", NAME, "Massimo", SURNAME, "Mazzetti", EMAIL, "mm@cinehub.com"),
                Map.of(ID, "vLmLJCuTwZZap4t4ngUclwUzwZ62", NAME, "Ivan", SURNAME, "Palmieri", EMAIL, "ip@cinehub.com"),
                Map.of(ID, "bvMrqf60V8OwETW9aEjeYbM9I0b2", NAME, "Mario", SURNAME, "Rossi", EMAIL, "mr@cinehub.com"),
                Map.of(ID, "JFDW7zA7pVh53im1Sl7fSnvaxML2", NAME, "Luigi", SURNAME, "Bianchi", EMAIL, "lb@cinehub.com"),
                Map.of(ID, "mg9eBHkPumcssl9dvrotbZqDbk62", NAME, "Steve", SURNAME, "Jobs", EMAIL, "sj@cinehub.com"),
                Map.of(ID, "C9o3hGHcfZXEXAjtJtlUEckE9WC2", NAME, "Bill", SURNAME, "Gates", EMAIL, "bg@cinehub.com"),
                Map.of(ID, "Tf6NcK4d8feY2TpuJVsqS74pbLf1", NAME, "Elon", SURNAME, "Musk", EMAIL, "em@cinehub.com"),
                Map.of(ID, "ikBgUbCQYlevLnLj7SOUb1PvS0h2", NAME, "Alan", SURNAME, "Turing", EMAIL, "at@cinehub.com"),
                Map.of(ID, "7jYsjrrXeFSUpu33TsdYwV135mx1", NAME, "James", SURNAME, "Gosling", EMAIL, "jg@cinehub.com"),
                Map.of(ID, "L02YH8zWNJXzXcwRIJSDyx3GOqC3", NAME, "Dennis", SURNAME, "Ritchie", EMAIL, "dr@cinehub.com"),
                Map.of(ID, "qTNkqPTioQO3cv953AqC3NR5NDf2", NAME, "Larry", SURNAME, "Page", EMAIL, "lp@cinehub.com"),
                Map.of(ID, "5KClU7hbNgedJAwLuF9eFVl6Qzz2", NAME, "Mark", SURNAME, "Zuckerberg", EMAIL, "mz@cinehub.com"),
                Map.of(ID, "ppgJVL8wS9bdjWxCxs6bll2K0Xs1", NAME, "Jeff", SURNAME, "Bezos", EMAIL, "jb@cinehub.com")
        ));
    }
